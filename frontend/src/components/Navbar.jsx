      ...
      <div className="container mx-auto px-4 py-3">
        <div className='flex flex-wrap justify-between items-center'>
          ...
          <nav className="flex flex-row items-center gap-4">
            ...
            {
              user ? (
                <button className='bg-gray-700 hover:bg-gray-600 text-white px-2 py-1 rounded-md transition duration-300 ease-in-out flex items-center'>
                  <LogOut size={18} />
                  <span className='hidden sm:inline ml-2'>Logout</span>
                </button>
              ) : (
                <><Link to={"/signup"} className='bg-emerald-600 hover:bg-emerald-700 text-white py-2 px-4 rounded-md transition duration-300 ease-in-out flex items-center'>
                  <UserPlus className='mr-2' size={18} />Sign Up
                </Link>
                  <Link
                    to={"/login"} className='bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 rounded-md transition duration-300 ease-in-out flex items-center'>
